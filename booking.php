  ...
  <div class="col-lg-8">
    <table class="table table-bordered">
      ...
      <tr class="adminlays">
       ...
       <a href="C:/xampp/htdocs/AdvancedCarParts/AdvancedCarParts/RequestRegisterComplete.php">
  <button type="submit" name="place_order" class="btn btn-primary center-block">
    <?php echo "Confirm" ?>
  </button>
</a>
